...
//===================================================================
			{
				...
				setContentView ( R.layout.lessons3 );
							...
							public void onClick ( View v )
								{
									...
									Intent int26= new Intent ( Lessons3.this, com.mcal.kotlinfree.lessons.Lesson26.class );
									startActivity ( int26 );
								}
						} );
							...
							public void onClick ( View v )
								{
									...
									Intent int27= new Intent ( Lessons3.this, com.mcal.kotlinfree.lessons.Lesson27.class );
									startActivity ( int27 );
								}
						} );
							...
							public void onClick ( View v )
								{
									...
									Intent int28= new Intent ( Lessons3.this, com.mcal.kotlinfree.lessons.Lesson28.class );
									startActivity ( int28 );
								}
						} );
							...
							public void onClick ( View v )
								{
									...
									Intent int29= new Intent ( Lessons3.this, com.mcal.kotlinfree.lessons.Lesson29.class );
									startActivity ( int29 );
								}
						} );
							...
							public void onClick ( View v )
								{
									...
									Intent int30= new Intent ( Lessons3.this, com.mcal.kotlinfree.lessons.Lesson30.class );
									startActivity ( int30 );
								}
						} );
